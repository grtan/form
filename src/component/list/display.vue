<template>
  <div class="fm-display__root">
    ...
    <template v-else-if="schema.type === 'string'">
      ...
      <!-- 文件 -->
      <v-file v-else-if="schema.format === 'file'" :schema="{ ...schema, readonly: true }" :value="value" />
    ...
    <!-- 布尔值 -->
    <el-switch v-else-if="schema.type === 'boolean'" :value="value" :disabled="true" />
